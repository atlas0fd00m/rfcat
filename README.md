...
* PySide6 (for Spectrum Analyzer GUI):  (Ubuntu 18.10+: python-pyside6)
    PySide6 is no longer installed automatically, due to support concerns for RPi platforms.  You can install it (if available for your platform) using `pip`:
